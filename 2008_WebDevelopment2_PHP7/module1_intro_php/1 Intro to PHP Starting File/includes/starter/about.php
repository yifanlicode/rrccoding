...
<body>
	<div id="container">
		...
		<nav>
			<ul>
				<li><a href="about.php">About RRC</a></li>
		...
		<section id="content">
			...
			<aside>
				<h2>Learn</h2>
				<p><img class="learn" src="images/learn.png" alt="Learn" type="image/png" />Aliquam faucibus leo quis velit eleifend lacinia. Maecenas tellus lectus, suscipit sit amet turpis quis, eleifend pretium odio.</p>
				<h2>Hub</h2>
